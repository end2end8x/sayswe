...
export default (trackedResources = [], firebaseConfig = {}, options = {}) => {
  ...
  return (type, resource, params) => {
    ...
    if(resource != "userChats" && resource != "message") {
      return new Promise(resolve => setTimeout(() => resolve(restClient(type, resource, params)), 500));
    } else

      if(resource === "message") {
        resource = "bl_session_message/wRHk0PB4Vd";
      }
