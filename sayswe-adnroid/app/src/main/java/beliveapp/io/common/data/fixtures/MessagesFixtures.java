package beliveapp.io.common.data.fixtures;
...
public final class MessagesFixtures extends FixturesData {
    ...
    public static Message getTextMessageUser(User user, String text) {
        return new Message(getRandomId(), user, text);
    }

    public static Message getTextMessageFirebase(FirebaseUser firebaseUser, String text) {
        User user = new User(
                "0",
